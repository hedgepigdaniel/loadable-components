...
function createLoadable(_ref) {
  ...
  function loadable(loadableConstructor, options) {
    ...
    function watchdog(importPromise, props) {
      if (options.watchdog) {
        return options.watchdog(importPromise.then(function () {}), props);
      }
    ...
    function (_React$Component) {
      ...
      _proto.loadAsync = function loadAsync() {
        ...
        if (!this.promise) {
          ...
          var importPromise = ctor.requireAsync(props);
          this.promise = Promise.all([importPromise, watchdog(importPromise, this.props)]).then(function (results) {
            var loadedModule = results[0];
